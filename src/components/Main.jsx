...
import illustDesk from '../assets/images/illustration-editor-desktop.svg';
...
export default function Main({isMobile}) {
  return (
    <main className="main">
      ...
      <div className='illustaration main'>
        <img src={isMobile ? illustMobile : illustDesk} alt="illustration" />
        <div >
      ...
      <div className="free_section">
        <img src={isMobile ? laptopMobile : laptopDesk} 
          alt='illustration laptop' className='illustration_laptop'
        />
        <div>
          <div>
